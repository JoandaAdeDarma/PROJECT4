                    ...
                    <div class="article-title">
                        <h2>
                            @if ($product->discount > 0)
                                <span style="text-decoration: line-through; color: rgb(5, 94, 132);">{{ $product->price }} Points</span>
                                <span class="ml-2" style="color: rgb(8, 216, 239);">{{ $product->price - ($product->price * $product->discount / 100) }} Points</span>
                            @else
                                <!-- No discount -->
